...
## How to Incorporate the Reviewer's Feedback into your PR
...
- To process a comment, make modifications directly to your branch and push normally. GitHub will automatically detect these changes and add them to your existing PR.
...
Reviews must be thorough. Sometimes, depending on the topic and the author's level of expertise, this process can be as time-consuming as writing a PR yourself.
...
- Think about what the author might have forgotten, such as some APIs or additional tests. Then, either request that they be added, add them yourself using suggestions, or create new tickets for them.
